...
>(({ side = 'left', variant = 'sidebar', collapsible = 'offcanvas', className, children, ...props }, ref) => {
  ...
  if (collapsible === 'none') {
    return (
      <div
        className={cn('bg-background/80 text-sidebar-foreground flex h-full w-[--sidebar-width] flex-col', className)}
        ref={ref}
        {...props}
      >
        {children}
    ...
    return (
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        <SheetContent
          ...
          data-mobile='true'
          className='bg-background/80 text-sidebar-foreground w-[--sidebar-width] p-0 [&>button]:hidden'
          style={
            {
  ...
  return (
    ...
    >
      ...
      >
        <div
          data-sidebar='sidebar'
          className='bg-background/80 group-data-[variant=floating]:border-sidebar-border flex h-full w-full flex-col group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border group-data-[variant=floating]:shadow'
        >
          {children}
        </div>
      </div>
